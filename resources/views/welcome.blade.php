...
@endsection
@section('heading')
    <div class="container xl bg-blend-soft-light m-auto">

        <h1 class="text-center font-bold text-gray-800 text-9xl">Lorem ipsum dolor sit amet.</h1>
        <div class="wrapper">
...
@section('content')
    <div class=" w-screen h-screen bg-red-100 ">
        <div class="grid grid-cols-2 bg-yellow-200  ">
            <h1 class="text-center text-9xl text-gray-900">Lorem, ipsum dolor.</h1>
            <div class=" grid-cols-2 bg-blue-200">
                <div class="">
